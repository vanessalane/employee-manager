    ...
    return new Promise(
        function(resolve, reject) {
            getAllEmployees(connection).then((res) => {
                ...
                if (managerPrompt) employeeChoices.push('None');
                inquirer.prompt({
                    type: 'list',
                    name: 'employee',
                    message: prompt,
                    ...
                    let employeeId;
                    if (managerPrompt && answer.choice === 'None') {
                        employeeId = null;
                    } else {
...
updateManager = (connection, employeeInfo) => {
    ...
    promptForEmployee(connection, employeePrompt).then((employeeId) => {
        ...
        promptForEmployee(connection, managerPrompt).then((managerId) => {
